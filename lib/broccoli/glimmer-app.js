...
const wrapWebComponents = require('./web-component-wrapper');
...
GlimmerApp.prototype.toTree = function(options) {
  ...
  // Generate manifest of components to wrap in Web Components.
  jsTree = merge([jsTree, wrapWebComponents(jsTree)]);
