...
RollupWithDependencies.prototype.build = function() {
  ...
  // I temporarily disabled ES2015 transpilation because Web Components natively
  // only work with real classes, not the transpiled version emitted by Babel. I
  // guess we want to include
  // https://github.com/webcomponents/custom-elements/blob/master/src/native-shim.js
  // and a polyfill for browsers that don't support Custom Elements anyway.
